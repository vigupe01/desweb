<?php
	...
	{
		//el error es que la funcion te devuelve el mismo numero que le pasas como valor
		//lo solucionamos cogiendo y multiplicando por -1  el numero de entrada 
			$entrada*= -1;
			return $entrada;
...
<html>
	...
	<body>
		<?php
			...
			echo "--------------------------------"."</br>";
			echo "Valor de salida=".avatarCode(1)." OK</br>";
			echo "</div>";
